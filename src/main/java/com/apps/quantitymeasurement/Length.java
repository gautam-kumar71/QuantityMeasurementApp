...
public class Length {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Convert 3 Feet to Inches: " + new Length(3.0, LengthUnit.FEET).convertTo(LengthUnit.INCHES));
		System.out.println(
				"Convert 2 Yards to Inches: " + new Length(2.0, LengthUnit.YARDS).convertTo(LengthUnit.INCHES));
		System.out.println(
